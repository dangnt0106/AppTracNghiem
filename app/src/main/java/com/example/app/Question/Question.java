...
public class Question implements Serializable {
    ...
    private String traloi=""; //luu tam bien tra loi cau hoi
    public int choiceID= -1; //gan gia tri cho radiobutton ho tro check id cho radiogroup
    ...
    public int get_idTest() {
        return _id;
    }

    public void set_idTest(int _id) {
        this._id = _id;
    }
